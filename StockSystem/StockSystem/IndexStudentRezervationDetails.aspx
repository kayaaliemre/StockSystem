<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IndexStudentRezervationDetails.aspx.cs" Inherits="StockSystem.IndexStudentRezervationDetails" %>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
               <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        <a href="IndexStudentRezervationDetails.aspx"><i class="fa fa-fw fa-edit"></i> Rezervasyon Detayları </a>
                    </li>
                    <li>
          ...
          <asp:Panel ID="Panel3" runat="server" GroupingText="Ders Bilgisi" Height="161px" Width="493px" Font-Bold="True">
              ...
              <br />
                        ...
                        <asp:Panel ID="Panel8" runat="server" CssClass="auto-style37" GroupingText="Seçilen Malzeme Bilgisi" Height="212px" Width="624px" >
                            <asp:GridView ID="gwSecilenMalzeme" runat="server" Height="96px" Width="567px" CssClass="auto-style22" CellPadding="4" ForeColor="#333333" >
                                <AlternatingRowStyle BackColor="White" />
                                <EditRowStyle BackColor="#2461BF" />
                                <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                      <asp:Button ID="btnGuncelle" runat="server" BackColor="Yellow" Height="46px" Text="Guncelle" Width="167px" OnClick="btnGuncelle_Click"  />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <asp:Button ID="btnSil" runat="server" BackColor="Red" Height="46px" Text="Sil" Width="167px" OnClick="btnSil_Click" CssClass="btn disabled" Enabled="False" />
